...
function pxMiddleware(req, res, next) {
    ...
    try {
        ...
        pxCtx.ip = (typeof pxconfig.GET_USER_IP == 'function' && pxconfig.GET_USER_IP()) || req.get(pxconfig.IP_HEADER) || req.px_user_ip || req.ip;
        ...
        if (req.cookies && req.cookies['_pxCaptcha']) {
            ...
            pxCaptcha.verifyCaptcha(pxCtx, pxcptch, (err, result) => {
                ...
                pxlogger.debug('perimeterx captcha verification passed, passing traffic');
