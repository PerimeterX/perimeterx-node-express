            ...
            pxCaptcha.verifyCaptcha(pxCtx, pxcptch, (err, result) => {
                if (err) {
                    if (err == "timeout") {
                        ...
                        pxCtx.pass_reason = "captcha_timeout";
...
function pxPass(pxCtx, next) {
    let details = {
        ...
        "pass_reason": pxCtx.pass_reason,
        'risk_rtt': pxCtx.risk_rtt
    };
