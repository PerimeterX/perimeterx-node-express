...
PX_INTERNAL.SERVER_HOST = 'https://collector.a.pxi.pub';
...
function init(params) {
    ...
    PX_DEFAULT.PROXY_URL = pxutil.configurationsOverriding(PX_DEFAULT, params, 'PROXY_URL', 'proxy');
    ...
    PX_DEFAULT.MAX_BUFFER_LEN = pxutil.configurationsOverriding(PX_DEFAULT, params, 'MAX_BUFFER_LEN', 'maxBufferLength');
