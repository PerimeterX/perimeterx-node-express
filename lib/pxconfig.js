...
function init(params) {
    ...
    PX_INTERNAL.SERVER_HOST = PX_DEFAULT.PX_APP_ID !== 'PX_APP_ID' ? PX_INTERNAL.SERVER_HOST = 'https://sapi-' + PX_DEFAULT.PX_APP_ID.toLowerCase() + '.glb1.perimeterx.net' : 'https://sapi.perimeterx.net';
    ...
    PX_DEFAULT.JS_REF = configurationsOverriding(PX_DEFAULT, params, 'JS_REF', 'jsRef');
    PX_DEFAULT.CSS_REF = configurationsOverriding(PX_DEFAULT, params, 'CSS_REF', 'cssRef');
    PX_DEFAULT.CUSTOM_LOGO = configurationsOverriding(PX_DEFAULT, params, 'CUSTOM_LOGO', 'customLogo');
