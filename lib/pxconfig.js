...
function init(params) {
    ...
    PX_INTERNAL.SERVER_HOST = PX_DEFAULT.PX_APP_ID !== 'PX_APP_ID' ? PX_INTERNAL.SERVER_HOST = 'https://sapi-' + PX_DEFAULT.PX_APP_ID + '.glb1.perimeterx.net' : 'https://sapi.perimeterx.net'; 
