...
PX_INTERNAL.MODULE_VERSION= 'NodeJS Module v1.9.0';
...
function init(params) {
    ...
    PX_DEFAULT.SENSITIVE_ROUTES = configurationsOverriding(PX_DEFAULT, params, 'SENSITIVE_ROUTES', 'sensitiveRoutes');
