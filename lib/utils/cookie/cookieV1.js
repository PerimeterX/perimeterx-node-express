...
class CookieV1 extends Cookie {
    ...
    get score() {
        return this.decodedCokie.s.b;
    }

    get hmac() {
        return this.decodedCokie.h;
    }

    isCookieFormatValid(cookie) {
        return pxutil.verifyDefined(cookie.t, cookie.s, cookie.s.a, cookie.s.b, cookie.u, cookie.v, cookie.h);
    }
    ...
    isSecure() {
        const baseHmacStr = '' + this.time + this.decodedCokie.s.a + this.score + this.uuid + this.vid;
